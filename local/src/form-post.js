    ...
    return(
        <div style={{margin: '30px'}}>
            <form ref={form} onSubmit={onSubmit}>
                ...
                <input type="text" name="email" size="43" placeholder="อีเมล" style={inputStyle}/><br/>
                <textarea name="message" rows="4" cols="40" placeholder="ข้อความ" style={inputStyle}></textarea><br/>
                <button>ตกลง</button>
            </form>
            <br/>
